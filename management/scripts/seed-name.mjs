// Create another manager account "name" with passcode "qweasdzxc1001"
// Run: node scripts/seed-name.mjs

const username = 'name';
const password = 'qweasdzxc1001';
...
VALUES ('${id}', '${username}', 'name@stillkinetic.local', '${hash}', 'manager', ${now});`;

console.log('-- Name seed SQL:');
console.log(sql);
